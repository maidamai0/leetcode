...
TEST_CASE("806. number-of-lines-to-write-string") {
  Solution s;
  {
    std::vector<int> widths{10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10,
                            10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10};
    std::string str{"abcdefghijklmnopqrstuvwxyz"};
    auto result = s.numberOfLines(widths, str);
    CHECK(result == std::vector<int>{3, 60});
  }

  {
    std::vector<int> widths{4,  10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10,
                            10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10};
